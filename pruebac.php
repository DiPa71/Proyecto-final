...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<br />
			<br />
			<h3>Tutorial - <a href="http://www.webslesson.info/2016/08/simple-php-mysql-shopping-cart.html" title="Simple PHP Mysql Shopping Cart">Simple PHP Mysql Shopping Cart</a></h3><br />
			<br /><br />
			<?php
			...
			<div class="col-md-4">
				<form method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;">
						<img src="images/<?php echo $row["img_p"]; ?>" class="img-responsive" /><br />

						<h4 class="text-info"><?php echo $row["nombre"]; ?></h4>

						<h4 class="text-danger">$ <?php echo $row["preci"]; ?></h4>
